                    ...
                    mediaRecorder.addEventListener("stop", () => {
                        ...
                        fetch(RUTA_SERVIDOR, {
                            ...
                            .then(respuestaComoTexto => {
                                ...
                                $duracion.innerHTML = `<strong>Audio subido correctamente.</strong>&nbsp; <a id="odueeee" name="${respuestaComoTexto}" value="${respuestaComoTexto}" target="_blank" href="${respuestaComoTexto}">Abrir</a>`
                            })
                    });
                })
                .catch(error => {
